...
## Emergent Gravity & Propulsion

| File | Description |
|------|-------------|
| `emergent_gravity/` | Gravity polarity, falling time, Buraq engineering, Cf sensor, spinner dynamo |
...
| File | Description |
|------|-------------|
| `galaxy_pipeline/batch_pipeline_v3_1.py` | Main pipeline script |
