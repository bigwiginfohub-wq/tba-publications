...
| 5 | `cosmology_map.md` | Delta-audited universe — Big Bang to planetary habitability (14 coordinates) |
| 6 | `quran_map.md` | Delta-audited Quran — 15 verses with empirical/metaphysical classification |
